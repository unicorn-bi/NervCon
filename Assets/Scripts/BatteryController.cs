...
namespace Gtec.UnityInterface
{
    public class BatteryController : MonoBehaviour
    {
        ...
        private void OnBatteryLevelAvailable(object sender, Chain.Common.SignalProcessingPipelines.ERPPipeline.BatteryLevelEventArgs e)
        {
            _currenBatteryLevel = e.BatteryLevel;
            _update = true;
        }

        private void OnBatteryLevelAvailable(object sender, Chain.Common.SignalProcessingPipelines.CVEPPipeline.BatteryLevelEventArgs e)
        {
            _currenBatteryLevel = e.BatteryLevel;
            _update = true;
        }
