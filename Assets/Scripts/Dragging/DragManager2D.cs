...
public class DragManager2D : MonoBehaviour
{
    ...
    private UIDraggable _currentDraggedObject = null;
    public UIDraggable CurrentDraggedObject => _currentDraggedObject;
    ...
    public void RegisterDraggedObject(UIDraggable drag)
    {
        _currentDraggedObject = drag;
        drag.transform.SetParent(_dragLayer);
    }

    public void UnregisterDraggedObject(UIDraggable drag)
    {
